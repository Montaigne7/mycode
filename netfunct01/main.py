...
def commandpush(devicecmd, devicereboot): # devicecmd==dict
...
def main():
    ...
    ## run
    commandpush(devicecmd, devicereboot) # call function to push commands to devices
